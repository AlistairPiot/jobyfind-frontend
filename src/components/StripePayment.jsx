...
// Composant principal avec chargement dynamique de Stripe
const StripePayment = ({ mission, onSuccess, onCancel }) => {
    ...
    if (loading || !StripeComponents) {
        return <LoadingSpinner />;
    }

    const { Elements, CardElement, useStripe, useElements, stripePromise } =
        StripeComponents;
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                            <p className="text-2xl font-bold text-blue-800">
                                {(STRIPE_CONFIG.applicationFee / 100).toFixed(
                                    2
                                )}{" "}
                                €
                            </p>
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-green-700 mt-1">
                                Ce paiement sera visible dans toutes les
                                sections de votre dashboard Stripe ! Carte de
